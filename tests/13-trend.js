...
export default function(){
    ...
    //aded reponse duration inside custom trend
    getApiTrend.add(response.timings.duration)
    getApiTrendWaiting.add(response.timings.waiting)

    const googleResponde = http.get('https://www.google.com');
    googleGetApiTrend.add(response.timings.duration)
    googleGetApiTrendWaiting.add(response.timings.waiting)

}

/*
     TREND_Get_Api_Duration..........: avg=577.016  min=577.016  med=577.016  max=577.016  p(90)=577.016  p(95)=577.016 
     TREND_Google_Get_Api_Duration...: avg=577.016  min=577.016  med=577.016  max=577.016  p(90)=577.016  p(95)=577.016 
     http_req_duration...............: avg=542.81ms min=508.61ms med=542.81ms max=577.01ms p(90)=570.17ms p(95)=573.59ms

     All 3 have diferent times
     Get API Trend -  Duration of Get API
     GoogleAPI TRend - duration of google API call
     Http req duration - cumulative results of all the API calls 
